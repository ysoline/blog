...
class CommentManager extends Manager
{
    ...
    {
        $_bdd = $this->dbConnect();
        $comments = $_bdd->prepare('SELECT id, title, author, comment, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin%ss\') AS comment_date_fr FROM comments WHERE post_id = ? ORDER BY comment_date DESC');
