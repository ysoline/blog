                ...
                <div class="bg-light rounded p-3">
                    ...
                    <?php foreach ($commentReport as $comment) { ?>
                        <div class="m-3">
                            ...
                            <a href="archiverCommentaire&amp;id=<?= $comment['c_id']; ?>" class="btn btn-outline-danger btn-sm">Désapprouver</a>
                            <a href="validerCommentaire&amp;id=<?= $comment['c_id']; ?>" class="btn btn-outline-success btn-sm">Approuver</a>
                ...
                <div class="bg-light rounded p-3 mt-2">
                    ...
                    <?php foreach ($unpublished as $Uncomment) { ?>
                        <div class="m-3">
                            ...
                            <a href="publierCommentaire&amp;id=<?= $Uncomment['c_id']; ?>" class="btn btn-outline-success btn-sm">Re-Publier</a>
